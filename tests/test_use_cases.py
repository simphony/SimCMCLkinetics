...
def _case_runner(case_cuds: Cuds, engine: KineticsEngine, model_flag: int) -> Cuds:
...
def test_carbon_black_momic(carbon_black_cuds: Cuds) -> None:
...
def test_carbon_black_stochastoc(carbon_black_cuds: Cuds) -> None:
    wrapper = _case_runner(
        case_cuds= carbon_black_cuds,
        engine= CarbonBlackEngine(),
